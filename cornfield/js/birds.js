...
var birdsTick = function() {
	...
	birdsTickTmpV.set(
		Math.sin(birdsPhase+animationTime*0.02)*100,
		Math.cos(birdsPhase+animationTime*0.03)*20+10,
	...
	for (var i = 0; i < birds.children.length; i++) {
		...
		if (bird.position.y < 8) {
			bird.position.y = 8;
			bird.velocity.multiplyScalar(0);
		}
