...
geo.addAttribute('normal', new THREE.BufferAttribute(normalArray,3));
geo.addAttribute('afStalkIndex', new THREE.BufferAttribute(new Float32Array(stalks),1));
//geo.computeFaceNormals();

var cornMesh = new THREE.Mesh(geo, cornShaderMat);
